WITH 
    ...
    , arbitrum_table as (
        SELECT 0x50db815D3c4B869F89925690E936ED85b0b76075 as "contract", 'PREMIA-TWAP-60, arbitrumPremia' as "name"
        UNION ALL
        SELECT 0xAD17b1bc8Ad4fbF3201CC59AFa94f951097662Af as "contract", 'SWETH, arbitrumSwellSweth' as "name"
        UNION ALL
        SELECT 0xd2F9EB49F563aAacE73eb1D19305dD5812F33179 as "contract", 'VST, vesta' as "name"
        UNION ALL
        SELECT 0x5908A61E8f88F56a772a0E5eD5f5c8264Fcf1A75 as "contract", 'SOFR, voltzArb' as "name"
        UNION ALL
        SELECT 0x2b28608Eb3c1b49EB9ebD528F5F4af4e36861784 as "contract", 'SOFR_EFFECTIVE_DATE, voltzArb' as "name"
        UNION ALL
        SELECT 0xC2597d9814FA26623a538840954aA3ea469EBAC3 as "contract", 'SOFRAI, voltzArb' as "name"
        UNION ALL
        SELECT 0xeeea43031F7E80753943bAdE67EEaaDE80Ba6390 as "contract", 'SOFRAI_EFFECTIVE_DATE, voltzArb' as "name"
    )

SELECT
    ac."date",
    at."name" as "contract_name",
    ac."txns"
FROM
    arbitrum_calls ac
LEFT JOIN
